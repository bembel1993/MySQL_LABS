...
INSERT INTO Препод VALUES(101, 'Иванов И.И.', 20);
INSERT INTO Препод VALUES(102, 'Астахов А.А.', 30);
INSERT INTO Препод VALUES(103, 'Евстафьева Е.И.',10);
INSERT INTO Препод VALUES(104, 'Зверева Л.Г.', 5);
INSERT INTO Препод VALUES(105, 'Мирский В.В.', 10);
----------------
...
CREATE TABLE Пов_кв
 ...
 PRIMARY KEY (ID_зан),
 FOREIGN KEY (ID_Тип)
  REFERENCES Тип_з(Тип)ON UPDATE CASCADE
   ON DELETE CASCADE,
 FOREIGN KEY (Ном_Предмета)
  REFERENCES Предмет(ID_Предмет)ON UPDATE CASCADE,
 FOREIGN KEY (ID_Преп)
  REFERENCES Препод(Ном_Преп)ON UPDATE CASCADE);

INSERT INTO Пов_кв VALUES(101, 'Математика', '2007-08-17', '2007-12-17', 1, 101, 101);
INSERT INTO Пов_кв VALUES(102, 'Английский', '2007-08-17', '2007-12-17', 2, 102, 102);
INSERT INTO Пов_кв VALUES(103, 'Русский', '2007-08-17', '2007-12-17', 1, 103, 103);
INSERT INTO Пов_кв VALUES(104, 'Химия', '2007-08-17', '2007-12-17', 1, 104, 104);
INSERT INTO Пов_кв VALUES(105, 'Информатика', '2007-08-17', '2007-12-17', 2, 105, 105);

UPDATE Пов_кв SET ID_зан=108, Наз_предмета='Программирование' WHERE ID_зан = 104;
